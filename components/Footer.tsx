...
export default function Footer() {
  ...
  // Avoid prefetching `/` to prevent loading Spline assets prematurely
      ...
      <div className="max-w-[1536px] mx-auto px-10 lg:px-24">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 mb-10">
          <div className="flex flex-col gap-2">
            <Logo dark />
            <p className="text-xs pl-9 tracking-[-0.01em]" style={{ color: "rgba(255,255,255,0.85)" }}>
              {t.footer.tagline}
            </p>
          </div>
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-x-5 gap-y-2">
            ...
            <button
              onClick={() => { localStorage.removeItem("nexa_cookie_consent"); window.location.reload(); }}
              className="text-[11px] tracking-[-0.01em] transition-opacity hover:opacity-60 cursor-pointer"
              style={{ color: "rgba(255,255,255,0.4)", background: "none", border: "none", padding: 0 }}
            >
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] tracking-wide" style={{ color: "rgba(255,255,255,0.95)" }}>All systems operational</span>
          </div>
        </div>
      </div>
    </footer>
